...
extern DadQSPI::cQSPI_FlasherStorage __FlashStorage; // QSPI object for accessing files in memory
...
protected:
    ...
    int8_t m_ActiveSubUI=-1;     // Currently active parameter tab
    int8_t m_SelectedSubUI=-1;   // Currently selected parameter tab
